...
//            CustomMovieLayout.invokeMoreFunction(requireContext(), getString(R.string.search_filters), queryMap)
        ...
        setCurrentTab(viewModel.uiState_old.homeFragmentState.tabPosition)

        /** Restore app bar state */
        if (viewModel.uiState_old.homeFragmentState.isAppBarExpanded == false)
    ...
    override fun onStop() {
        super.onStop()
        viewModel.uiState_old.homeFragmentState.isAppBarExpanded =
            binding.appBarLayout.isAppBarExpanded
        viewModel.uiState_old.homeFragmentState.tabPosition =
