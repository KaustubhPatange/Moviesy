private object LibraryVersion {
    ...
    const val NAVIGATOR = "0.1-alpha13"
    const val NAVIGATOR_BOTTOM_NAVIGATION = "0.1-alpha09"
    const val NAVIGATOR_TAB_NAVIGATION = "0.1-alpha03"
    const val NAVIGATOR_EXTENSIONS = "0.2"
